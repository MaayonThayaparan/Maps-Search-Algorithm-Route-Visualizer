...
public abstract class Graph {
	...
	public List<Integer> degreeSequence() {
		...
		for (int i = 0; i < getNumVertices(); i++) {
			int currDegree = getNeighbors(i).size() + getInNeighbors(i).size();
	...
	public static void main (String[] args) {
		...
		GraphLoader.createIntersectionsFile("data/maps/morgansgrant.map", "data/intersections/morgansgrant.intersections");
		...
		GraphAdjMatrix graphFromFile4 = new GraphAdjMatrix();
		GraphLoader.loadRoadMap("data/testdata/simpletest.map", graphFromFile4);
		System.out.println(graphFromFile.getDistance2(0));
		System.out.println(graphFromFile4.getDistance2(0));
		
		
		
		/*
		System.out.println("****");
		System.out.println("Roads / Real Data:");
		...
		System.out.println("****");
		System.out.println("Intersections Morgans Grant:");
		GraphAdjList graphFromFile3 = new GraphAdjList();
		GraphLoader.loadRoadMap("data/maps/morgansgrant.map", graphFromFile3);
